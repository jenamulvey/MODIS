...
for (i in 01:12) {
  ...
  product    = "MOD13Q1"
  month      = i
  year       = 2000  #remember also to change the year line #138 in the RModis.R; save; and source again
  h          = 18:19
  v          = 7:8
  ver        = "005"
  tmp.dir    = "./"
...
dir.create("2000_reproject", showWarnings=F)

#list all the files of 2014 as inputs
ip<- list.files(pattern = "MOD13Q1_2000-.*.tif",full.names = T) 
ip
...
op<-paste("./2000_reproject/",ip2,"_laea.tif",sep="")
op
...
#list the files
folder = "/data3/rstudio/EVINDVI/2000_reproject"
